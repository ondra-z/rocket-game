...
function setup() {//----------------SETUP-----------------------------
  ...
  birdYcor = 50;
  counter = 0;
  gameMode = 2; //2 = before start, 1 = game active, 0 = gameOver
  scale = 3;
  fallSpeed = 4;
  jumpTime = 100;
  OGbirdYcor = 50;
  ...
  margin = 100; //how close the gap can be to bottom of top of the canvas
...
function drawBackground(){
  for(var i=0; i <3; i++){
    image(imgCloud, colXcor[i]+100, 500, 80, 30);
  }
